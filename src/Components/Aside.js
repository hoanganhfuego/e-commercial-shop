    ...
    return(
        <div className="category">
            ...
            <div className="category-dropdown">
                ...
                <Link to={`${'tshirt'}`}><li className="row-5 cs" id="2" onClick={handleChangeCategory} style={productsCategory.tshirt?{border: 'solid 2px black'}:{border:'none'}}>tshirt</li></Link>
